...
const PregnantCows = () => {
  ...
  // Filter cows to include only those that are pregnant
  const pregnantCows = cows.filter((cow) => cow.pregnant);

  // Further filter based on the search input
  const filteredCows = pregnantCows.filter((cow) =>
